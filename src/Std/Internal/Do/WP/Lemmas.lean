...
section
variable {m : Type u → Type v} [Monad m] [Assertion Pred] [Assertion EPred] [∀ α, WP (m α) α Pred EPred] [WPMonad m Pred EPred]
...
section
variable {m : Type u → Type v} [Monad m] [Assertion Pred] [Assertion EPred] [∀ α, WP (m α) α Pred EPred] [WPMonad m Pred EPred] [MonadExceptOf ε m]
